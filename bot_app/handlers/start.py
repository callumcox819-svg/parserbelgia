...
ACCESS_TEXT = (
    "👋 Главное меню\n\n"
    "▶️ **Запустить парсер** — JSON по категориям\n"
    "⚙️ **Настройки** — площадка (2dehands / Ricardo / **Австрия**), "
    "категории, лимит, прокси\n"
    "Продавцы не повторяются — **личный ЧС** у каждого пользователя.\n"
    "Во время парсинга — кнопка **СТОП** (отдать JSON сейчас).\n"
    "Если лимит JSON не набирается вовремя — бот отдаёт частичный результат."
)
